<template>
  <div class="info">
    ...
    <div style="margin:16px;">
        <van-button round block type="info" @click="seeDm(news.acturl)"  v-if="news.type == 0">去下载</van-button>
        <van-button round block type="info" @click="seeDm(news.acturl)"  v-if="news.type == 1">去玩玩</van-button>
        <van-button round block type="info" @click="seeDm(news.acturl)"  v-if="news.type == 2">去逛逛</van-button>
    </div>
